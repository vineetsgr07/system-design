...
Exercise the use of more traditional systems - don't use graph-specific solutions such as [GraphQL](https://graphql.org/) or a graph database like [Neo4j](https://neo4j.com/)
...
* Use a **Graph Database** such as [Neo4j](https://neo4j.com/) or a graph-specific query language such as [GraphQL](https://graphql.org/) (if there were no constraint preventing the use of **Graph Databases**)
