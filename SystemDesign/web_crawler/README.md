...
Exercise the use of more traditional systems - don't use existing systems such as [solr](https://lucene.apache.org/solr/) or [nutch](https://nutch.apache.org/).
...
We'll assume we have an initial list of `links_to_crawl` ranked initially based on overall site popularity.  If this is not a reasonable assumption, we can seed the crawler with popular sites that link to outside content such as [Yahoo](https://www.yahoo.com/), [DMOZ](https://www.dmoz.org/), etc
...
* Discuss tradeoffs:
    * External communication with clients - [HTTPS APIs following REST](https://github.com/donnemartin/system-design-primer#representational-state-transfer-rest)
